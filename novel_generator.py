...
class NovelGenerator:
    ...
    def generate_file(self, path_name: str, messages: list[Message]):
        ...
        while True:
            ...
            check = self.generate(f'检查 {path_name}', [
                {"role": "system",
                    "content": "你是一个资深的小说审稿人，根据设定集，对用户的输入文本的各方面做出评价和评分（1-10分），重点关注是否存在情节叙事不清、逻辑结构混乱、内容质量低下等问题，并提出优化建议"},
    ...
    def generate_outline(self):
        ...
        self.generate_file("总纲.md", [
            {"role": "system", "content": "你是一个专业的小说总纲生成器，根据用户的要求生成小说的总纲，包括有多少卷以及每一卷的大致内容。仅输出总纲内容，不包含任何额外的内容和符号。"},
