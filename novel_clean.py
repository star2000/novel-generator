...
def clean_novel(novel_dir: Path):
    ...
    for part in parts:
        ...
        for chapter in chapters:
            ...
            if text.exists():
                ...
                text.write_text(new_content, encoding='utf-8')
                print(diff(content, new_content))
...
if __name__ == "__main__":
    ...
    if args.book_name:
        clean_novel(output_dir / args.book_name)
    else:
        for novel_dir in output_dir.glob('*/'):
            clean_novel(novel_dir)
